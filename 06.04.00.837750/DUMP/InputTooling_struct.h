...
// Enum InputTooling.EAimToolingConfig
enum class EAimToolingConfig : uint8 {
	...
	NewTargetRampUpTime = 25,
	Count = 26,
	Invalid = 254,
	EAimToolingFeature_MAX = 255,
	EAimToolingConfig_MAX = 256
};
...
enum class EAimToolingFeature : uint8 {
	...
	TargetFriction = 7,
	FlashTurning = 8,
	NoTargetFalloffTimeDeceleration = 9,
	NoTargetFalloffTimeFrameOfReference = 10,
	NoTargetFalloffTimeStrafeAssist = 11,
	NoTargetFalloffTimeTargetFriction = 12,
	NoTargetFalloffTimePullToCenter = 13,
	NewTargetRampUpDeceleration = 14,
	NewTargetRampUpFrameOfReference = 15,
	NewTargetRampUpStrafeAssist = 16,
	NewTargetRampUpTargetFriction = 17,
	NewTargetRampUpPullToCenter = 18,
	Count = 19,
	Invalid = 254,
	EAimToolingFeature_MAX = 255
};

// Enum InputTooling.EMovementToolingConfig
enum class EMovementToolingConfig : uint8 {
	...
	FastStrafingCounterStrafeThreshold = 8,
	FastStrafingCounterStrafeMaxSpeed = 9,
	InitialFastStrafingStickDeltaThreshold = 10,
	InitialFastStrafingPlayerSpeedCutoff = 11,
	FastReleasePower = 12,
	FastReleaseMinSpeed = 13,
	Count = 14,
	Invalid = 254,
	EMovementToolingFeature_MAX = 255,
	EMovementToolingConfig_MAX = 256
};
...
struct FAimToolingStrafeAssistFeatureTuningSet {
	...
	enum class EAimToolingStrafeAssistMode AimToolingStrafeAssistMode; // 0x04(0x01)
...
// ScriptStruct InputTooling.AimToolingFeatureConfigMapping
// Size: 0x18 (Inherited: 0x00)
struct FAimToolingFeatureConfigMapping {
	enum class EAimToolingFeature Feature; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct TArray<enum class EAimToolingConfig> ConfigList; // 0x08(0x10)
};

// ScriptStruct InputTooling.MovementToolingFeatureConfigMapping
// Size: 0x18 (Inherited: 0x00)
struct FMovementToolingFeatureConfigMapping {
	enum class EMovementToolingFeature Feature; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct TArray<enum class EMovementToolingConfig> ConfigList; // 0x08(0x10)
};
