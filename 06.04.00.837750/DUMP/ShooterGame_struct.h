...
enum class EAresIntSettingName : uint8 {
	...
	PlayerPerfShowFrameCount = 55,
	PlayerPerfShowNetworkJitter = 56,
	PlayerPerfShowEndToEndLatency = 57,
	PlayerPerfShowFiringErrors = 58,
	PlayerPerf_LastSetting = 59,
	NetworkSmoothing = 60,
	ShootingRangeSkillTestSetting = 61,
	ShootingRangePlantModuleDifficultySetting = 62,
	ShootingRangeDefuseModuleDifficultySetting = 63,
	GamepadSavedPreset = 64,
	GamepadSavedAimCurve = 65,
	GamepadSavedAimCurveZoomed = 66,
	GamepadSavedAimCurveAngularDeadzone = 67,
	GamepadAnalogMoveThresholdMode = 68,
	TouchDoubleTapRight = 69,
	TouchHUDPreset = 70,
	TouchDoubleTapLeft = 71,
	TouchAimAccelerationCurveX = 72,
	TouchAimAccelerationCurveY = 73,
	TouchAimADSAccelerationCurveX = 74,
	TouchAimADSAccelerationCurveY = 75,
	TouchAimSniperAccelerationCurveX = 76,
	TouchAimSniperAccelerationCurveY = 77,
	TouchJoystickStyle = 78,
	TouchSniperZoomLevelSetting = 79,
	TouchOperatorZoomCycleStyle = 80,
	TouchOperatorZoomCycleStyle_CachedAllLevels = 81,
	TouchOperatorZoomCycleStyle_CachedLevelOne = 82,
	TouchOperatorZoomCycleStyle_CachedLevelTwo = 83,
	TouchAimSensitivityPreset = 84,
	TouchGyroSensitivityPreset = 85,
	TouchTrackballSensitivityPreset = 86,
	TouchDoubleTapTopLeft = 87,
	TouchDoubleTapTopMiddle = 88,
	TouchDoubleTapTopRight = 89,
	TouchDoubleTapMiddleLeft = 90,
	TouchDoubleTapMiddle = 91,
	TouchDoubleTapMiddleRight = 92,
	TouchDoubleTapBottomLeft = 93,
	TouchDoubleTapBottomMiddle = 94,
	TouchDoubleTapBottomRight = 95,
	TouchNumVerticalRegions = 96,
	TouchNumHorizontalRegions = 97,
	MaxFramerateInBuyPhase = 98,
	MaxFramerateInGamePhase = 99,
	MaxFramerateInSpectatorView = 100,
	LastSeenRoamingSettingsVersion = 101,
	EAresIntSettingName_MAX = 102
};
...
enum class EGameFeatureToggleName : uint8 {
	...
	PODetection = 160,
	ExpireFoWCacheOnRoundBegin = 161,
	MobileAllySendRateLimiting = 162,
	MovementSyncDoor = 163,
	PremiumContentToggle0 = 164,
	PremiumContentToggle1 = 165,
	PremiumContentToggle2 = 166,
	PremiumContentToggle3 = 167,
	PremiumContentToggle4 = 168,
	PremiumContentToggle5 = 169,
	PremiumContentToggle6 = 170,
	PremiumContentToggle7 = 171,
	PremiumContentToggle8 = 172,
	PremiumContentToggle9 = 173,
	GradualMovementCorrections = 174,
	DebugMenuEnabledDefault = 175,
	UseMeshMaterialManager = 176,
	OmenCustomEQS = 177,
	OmenWallToggle = 178,
	VisionConeIntersectionFix = 179,
	FoWRelevancyCacheForceUpdate = 180,
	CorpsesBlockWorldDynamic = 181,
	PandemicToxicScreenCollisionFixes = 182,
	RateLimitClientInputs = 183,
	ErrorPowerByStabilityType = 184,
	AccoladesEnabled = 185,
	PremierGameEvents = 186,
	EquippableCacheRecycling = 187,
	ViperPitIgnoreCrawlspaceToggle = 188,
	PreventMovementInputEnforcement = 189,
	BufferedZoomRespectsValidStates = 190,
	EsportsGameEvents = 191,
	ScaledHeadshotFX = 192,
	Count = 193,
	Invalid = 254,
...
enum class EAresPlatformWidgetFamily : uint8 {
	...
	Premier = 5,
	COUNT = 6,
	EAresPlatformWidgetFamily_MAX = 7
};
...
enum class EPlatformInitErrorReason : uint8 {
	...
	Count = 85,
	EPlatformInitErrorReason_MAX = 86
};
...
enum class EPlayerPerfMetricCategory : uint8 {
	...
	FrameCount = 39,
	NetworkJitter = 40,
	FullEndToEndLatency = 41,
	FiringError = 42,
	EnumCount = 43,
	EPlayerPerfMetricCategory_MAX = 44
};
...
struct FDailyRewardsPlayer {
	...
	struct TArray<struct FDailyRewardsMatches> ProcessedMatches; // 0x20(0x10)
};

// ScriptStruct ShooterGame.DailyRewardsMatches
// Size: 0x20 (Inherited: 0x00)
struct FDailyRewardsMatches {
	struct FGuid ID; // 0x00(0x10)
	int32_t Progress; // 0x10(0x04)
	int32_t XP; // 0x14(0x04)
	int32_t SoftCurrency; // 0x18(0x04)
	bool WasPenalized; // 0x1c(0x01)
	bool WasBonusApplied; // 0x1d(0x01)
...
struct FPremierRoster {
	...
	int32_t LeagueMatchesPlayed; // 0x24(0x04)
	int32_t TournamentsPlayed; // 0x28(0x04)
	char pad_2C[0x4]; // 0x2c(0x04)
	int64_t Version; // 0x30(0x08)
};
