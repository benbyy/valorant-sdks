...
// ScriptStruct AISpatialAwareness.SelectedDefensePointInfo
// Size: 0x14 (Inherited: 0x00)
struct FSelectedDefensePointInfo {
	struct FVector SelectedDefensePoint; // 0x00(0x0c)
	float Score; // 0x0c(0x04)
	float TimeOfLastQuery; // 0x10(0x04)
};
...
struct FInfluenceMapDebugData {
	...
	struct FInfluenceLayerDebugInfo LayerDebugInfo; // 0x08(0x48)
	struct TArray<int32_t> NodeIndicesToDebugDraw; // 0x50(0x10)
	struct TArray<struct FInfluenceNodeDebugValue> InfluenceNodeDebugValues; // 0x60(0x10)
	struct TArray<struct FInfluenceNodeDebugInfo> InfluenceNodeDebugData; // 0x70(0x10)
	struct TArray<struct FInfluenceNodeNeighborDebugInfo> InfluenceNodeNeighborDebugInfo; // 0x80(0x10)
};
...
struct FMapMarkupWaypointDebugData {
	struct AMapMarkupWaypoint* FocusedWaypoint; // 0x00(0x08)
	struct TArray<struct AMapMarkupRoom*> FocusedRooms; // 0x08(0x10)
	struct TArray<struct AMapMarkupWaypoint*> WaypointsToDebugDraw; // 0x18(0x10)
};
