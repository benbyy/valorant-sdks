...
struct UWidget_Ability_Element_ChargeStandard_C : UWidget_Ability_Element_Charge_Base_C {
	...
	void OnStartWidget(); // Function Widget_Ability_Element_ChargeStandard.Widget_Ability_Element_ChargeStandard_C.OnStartWidget // (BlueprintCosmetic|Event|Protected|BlueprintEvent) // @ game+0x34b46f0
	void ExecuteUbergraph_Widget_Ability_Element_ChargeStandard(int32_t EntryPoint); // Function Widget_Ability_Element_ChargeStandard.Widget_Ability_Element_ChargeStandard_C.ExecuteUbergraph_Widget_Ability_Element_ChargeStandard // (Final|UbergraphFunction) // @ game+0x34b46f0
	void DispatchUpdateWidget_0__DelegateSignature(); // Function Widget_Ability_Element_ChargeStandard.Widget_Ability_Element_ChargeStandard_C.DispatchUpdateWidget_0__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x34b46f0
};
