...
enum class EAresBoolSettingName : uint8 {
	...
	GyroTapShoot = 174,
	GyroShootingAxisSwap = 175,
	GyroShootingAxisInvert = 176,
	GyroShootingDisplayBar = 177,
	GyroMovementAxisInvertVertical = 178,
	GyroMovementAxisInvertHorizontal = 179,
	EAresBoolSettingName_MAX = 180
};
...
enum class EGameFeatureFloatConfigName : uint8 {
	...
	GamepadFlashTurningAimAccelDelayScale = 25,
	GamepadFlashTurningAimAccelRampUpScale = 26,
...
// Enum ShooterGame.EActorMovementSync
enum class EActorMovementSync : uint8 {
	None = 0,
	Start = 1,
	Stop = 2,
	StartAndStop = 3,
	Count = 4,
	EActorMovementSync_MAX = 5
};

// Enum ShooterGame.EActorStateContext
enum class EActorStateContext : uint8 {
	None = 0,
	TriggeringState = 1,
	OwningActor = 2,
	OwningCharacter = 3,
	CustomContext = 4,
	Count = 5,
	EActorStateContext_MAX = 6
};

// Enum ShooterGame.EActorReplacementStateType
enum class EActorReplacementStateType : uint8 {
	None = 0,
	DisabledFallback = 1,
	Count = 2,
	EActorReplacementStateType_MAX = 3
};
...
struct FPremierLeaderboardEntry {
	...
	struct FUnverifiedMetadataPersonalization Personalization; // 0x18(0x40)
	int32_t Wins; // 0x58(0x04)
	int32_t Losses; // 0x5c(0x04)
};
...
struct FLeaderboardRankingDTO {
	...
	char pad_19[0x7]; // 0x19(0x07)
	struct FAdditionalData additionalInfo; // 0x20(0x58)
};
...
struct FAdditionalData {
	...
	int32_t Wins; // 0x10(0x04)
	int32_t Losses; // 0x14(0x04)
	struct FUnverifiedMetadataPersonalization Personalization; // 0x18(0x40)
};
...
struct FPremierRoster {
	...
	char pad_44[0x4]; // 0x44(0x04)
	int64_t Version; // 0x48(0x08)
	struct FPremierRosterCustomization CustomizationData; // 0x50(0x40)
};
