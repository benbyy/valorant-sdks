...
struct FRCPresetDescription {
	struct FString Name; // 0x00(0x10)
	struct FString Path; // 0x10(0x10)
	struct TArray<struct FRCPresetLayoutGroupDescription> Groups; // 0x20(0x10)
};
...
struct FRCExposedFunctionDescription {
	...
	char pad_C[0x4]; // 0x0c(0x04)
	struct FRCFunctionDescription UnderlyingFunction; // 0x10(0x30)
};
...
struct FRCExposedPropertyDescription {
	struct FName DisplayName; // 0x00(0x0c)
	char pad_C[0x4]; // 0x0c(0x04)
	struct FRCPropertyDescription UnderlyingProperty; // 0x10(0xa0)
};
...
struct FRCPresetFieldsAddedEvent {
	...
	struct FRCPresetDescription Description; // 0x20(0x30)
};
...
struct FRCPresetFieldsRemovedEvent {
	...
	struct FName PresetName; // 0x10(0x0c)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct TArray<struct FName> RemovedFields; // 0x20(0x10)
};
...
struct FRCPresetFieldsRenamedEvent {
	...
	struct FName PresetName; // 0x10(0x0c)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct TArray<struct FRCPresetFieldRenamed> RenamedFields; // 0x20(0x10)
};
...
struct FSearchActorResponse {
	struct TArray<struct FRCActorDescription> Actors; // 0x00(0x10)
};
...
struct FGetPresetResponse {
	struct FRCPresetDescription Preset; // 0x00(0x30)
};
