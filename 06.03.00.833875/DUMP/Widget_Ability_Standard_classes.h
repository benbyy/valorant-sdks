...
struct UWidget_Ability_Standard_C : UWidget_Ability_Parent_C {
	...
	void OnStartWidget(); // Function Widget_Ability_Standard.Widget_Ability_Standard_C.OnStartWidget // (BlueprintCosmetic|Event|Protected|BlueprintEvent) // @ game+0x3405eb0
	void AddTimer(struct UUserWidget* InTimerWidget); // Function Widget_Ability_Standard.Widget_Ability_Standard_C.AddTimer // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3405eb0
	void ExpireWarningActive_Event_1(); // Function Widget_Ability_Standard.Widget_Ability_Standard_C.ExpireWarningActive_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x3405eb0
	void TimerComplete_Event_1(); // Function Widget_Ability_Standard.Widget_Ability_Standard_C.TimerComplete_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x3405eb0
	void PreConstruct(bool IsDesignTime); // Function Widget_Ability_Standard.Widget_Ability_Standard_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3405eb0
	void OnInitialized(); // Function Widget_Ability_Standard.Widget_Ability_Standard_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3405eb0
	void ExecuteUbergraph_Widget_Ability_Standard(int32_t EntryPoint); // Function Widget_Ability_Standard.Widget_Ability_Standard_C.ExecuteUbergraph_Widget_Ability_Standard // (Final|UbergraphFunction) // @ game+0x3405eb0
};
