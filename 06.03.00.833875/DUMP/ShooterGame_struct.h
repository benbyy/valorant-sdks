...
enum class EGameFeatureToggleName : uint8 {
	...
	OmenCustomEQS = 178,
	OmenWallToggle = 179,
	VisionConeIntersectionFix = 180,
	FoWRelevancyCacheForceUpdate = 181,
	CorpsesBlockWorldDynamic = 182,
	PandemicToxicScreenCollisionFixes = 183,
	ViperPitCellSizeToggle = 184,
	RateLimitClientInputs = 185,
	ErrorPowerByStabilityType = 186,
	AccoladesEnabled = 187,
	PremierGameEvents = 188,
	EquippableCacheRecycling = 189,
	ViperPitIgnoreCrawlspaceToggle = 190,
	PreventMovementInputEnforcement = 191,
	BufferedZoomRespectsValidStates = 192,
	EsportsGameEvents = 193,
	Count = 194,
	Invalid = 254,
...
// Enum ShooterGame.DEPRECATED_EAresPartyTournamentStartAvailability
enum class DEPRECATED_EAresPartyTournamentStartAvailability : uint8 {
	Unavailable_InQueue = 0,
	Unavailable_TournamentQueueNotOpen = 1,
	Unavailable_LockInToPlay = 2,
	Unavailable_AwaitingLockIn = 3,
...
struct FMatchup {
	...
	char pad_15[0x3]; // 0x15(0x03)
	int32_t MatchupNumber; // 0x18(0x04)
	char pad_1C[0x4]; // 0x1c(0x04)
	struct TArray<struct FMatchupParticipant> Participants; // 0x20(0x10)
	struct FString Status; // 0x30(0x10)
	bool Complete; // 0x40(0x01)
	char pad_41[0x7]; // 0x41(0x07)
	int64_t ScheduledStartDateInEpochSeconds; // 0x48(0x08)
	struct TArray<struct FMatchupGame> Games; // 0x50(0x10)
};
...
struct FGetStorefrontResponseV3 {
	...
	struct FAccessoryStorefront AccessoryStore; // 0x158(0x10)
	struct FJuiceBoxStorefront JuiceBoxStore; // 0x168(0x18)
	struct FUpgradeCurrencyStorefront UpgradeCurrencyStore; // 0x180(0x10)
};
...
struct FAccessoryStoreOfferDTO {
	struct FGuid AccessoryOfferID; // 0x00(0x10)
