...
struct AFXC_SensitivityModifier_Gamepad_C : AEffectContainer {
	...
	void StopEffect(enum class EStopEffectType StopEffectType); // Function FXC_SensitivityModifier_Gamepad.FXC_SensitivityModifier_Gamepad_C.StopEffect // (Event|Public|BlueprintEvent) // @ game+0x3367a20
	void ExecuteUbergraph_FXC_SensitivityModifier_Gamepad(int32_t EntryPoint); // Function FXC_SensitivityModifier_Gamepad.FXC_SensitivityModifier_Gamepad_C.ExecuteUbergraph_FXC_SensitivityModifier_Gamepad // (Final|UbergraphFunction) // @ game+0x3367a20
};
