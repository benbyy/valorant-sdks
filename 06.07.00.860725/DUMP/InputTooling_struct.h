...
// ScriptStruct InputTooling.AimToolingFlashTurningSharedTuningSet
// Size: 0x0c (Inherited: 0x00)
struct FAimToolingFlashTurningSharedTuningSet {
...
struct FAimToolingTargetManagementSharedTuningSet {
	float TargetManagementOuterRadiusX; // 0x00(0x04)
	float TargetManagementOuterRadiusY; // 0x04(0x04)
	float TargetManagementOuterRadiusMinScalePct; // 0x08(0x04)
	float TargetManagementOuterRadiusMaxScalePct; // 0x0c(0x04)
	float TargetManagementMinBiasDistance; // 0x10(0x04)
	float TargetManagementMaxBiasDistance; // 0x14(0x04)
	float TargetManagementOverTargetWeight; // 0x18(0x04)
	bool bIsTargetManagementOverTargetNormalized; // 0x1c(0x01)
	char pad_1D[0x3]; // 0x1d(0x03)
	float TargetManagementDistanceWeight; // 0x20(0x04)
	bool bIsTargetManagementDistanceNormalized; // 0x24(0x01)
	char pad_25[0x3]; // 0x25(0x03)
	float TargetManagementPreviousTargetWeight; // 0x28(0x04)
	float TargetManagementPreviousTargetDecay; // 0x2c(0x04)
	bool ENGINEERING_ONLY_CHECK_TO_MODIFY_VALUES_BELOW; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	float PotentialTargetMaxAngle; // 0x34(0x04)
	float DefaultRawInputVectorSize; // 0x38(0x04)
};
