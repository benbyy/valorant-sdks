...
enum class EGameFeatureToggleName : uint8 {
	...
	LiveDiagnostics = 127,
	FXCInitialReplicationFix = 128,
	RemoteClientQueueSizeTrackingFix = 129,
	RoundEndMulticastBugfix = 130,
	ExpandedGestures = 131,
	DeathPuckSizeAdjustment = 132,
	GyroShooting = 133,
	EnableCombatReportEventDeferral = 134,
	UseAbilityTrackingComponent = 135,
	RestoreSetReplicatesRGIs = 136,
	FixActorComponentBlockingDormancy = 137,
	GyroMovement = 138,
	RelativeTriggerEnabled = 139,
	AudioVisualization = 140,
	AudioVisualizationIconFootstep = 141,
	AudioVisualizationLOS = 142,
	AudioVisualizationMaterialFootstep = 143,
	MultichannelAudioVisualization = 144,
	ReplicationSleepFix = 145,
	RevertMobileFiringError = 146,
	CancelUsableOnServerCorrect = 147,
	BurstFire = 148,
	BuffDamageRefactor = 149,
	MinimapPauseUnseenEnemyUpdates = 150,
	SkyeSeekerRefactor = 151,
	SageWallFindFloorUsingCapsuleSweep = 152,
	ActorDormancyRespectsRelevancy = 153,
	BufferedZoomStates = 154,
	PODetection = 155,
	ExpireFoWCacheOnRoundBegin = 156,
	MobileAllySendRateLimiting = 157,
	MovementSyncDoor = 158,
	PremiumContentToggle0 = 159,
	PremiumContentToggle1 = 160,
	PremiumContentToggle2 = 161,
	PremiumContentToggle3 = 162,
	PremiumContentToggle4 = 163,
	PremiumContentToggle5 = 164,
	PremiumContentToggle6 = 165,
	PremiumContentToggle7 = 166,
	PremiumContentToggle8 = 167,
	PremiumContentToggle9 = 168,
	GradualMovementCorrections = 169,
	DebugMenuEnabledDefault = 170,
	UseMeshMaterialManager = 171,
	OmenCustomEQS = 172,
	OmenWallToggle = 173,
	VisionConeIntersectionFix = 174,
	FoWRelevancyCacheForceUpdate = 175,
	CorpsesBlockWorldDynamic = 176,
	PandemicToxicScreenCollisionFixes = 177,
	RateLimitClientInputs = 178,
	ErrorPowerByStabilityType = 179,
	AccoladesEnabled = 180,
	PremierGameEvents = 181,
	EquippableCacheRecycling = 182,
	ViperPitIgnoreCrawlspaceToggle = 183,
	BufferedZoomRespectsValidStates = 184,
	EsportsGameEvents = 185,
	ScaledHeadshotFX = 186,
	ExplicitCharacterLoading = 187,
	MinimapFloors = 188,
	ShortTermNPEUpdates = 189,
	PatchHeightJumpCrouchExploitFix = 190,
	PatchHeightJumpCrouchExploitFixGekko = 191,
	FootstepDecayWhileWalking = 192,
	SystemicAbilityUpdates = 193,
	ConcussLowTickRate = 194,
	BombDestroysAllDestructibles = 195,
	OnlyDropCurrentEquippable = 196,
	FXCPerspectiveUpdatedOnSameFrameFix = 197,
	ObserverMinimapComponentLocation = 198,
	EnableIncreasedNetDriverRateLimiting = 199,
	CellularPatchMultipleNodeOverlapCheck = 200,
	Count = 201,
	Invalid = 254,
...
enum class EEquippableSkinLevelItem : uint8 {
	...
	EEquippableSkinLevelItem_MAX = 17
};
...
enum class EAresPartyTournamentStartAvailability : uint8 {
	...
	Unavailable_TournamentLimitReached = 7,
	Unavailable_NotEnoughPoints = 8,
	Unavailable_Unenrolled = 9,
	Available_PartyLeader = 10,
	Available_NotPartyLeader = 11,
	TournamentStarted = 12,
	EAresPartyTournamentStartAvailability_MAX = 13
};
...
struct FTournamentData {
	...
	struct TArray<struct FString> RosterEventIneligibilities; // 0x50(0x10)
};
...
struct FPremierLeaderboardEntry {
	...
	struct FPremierRosterCustomization Customization; // 0x28(0x40)
...
struct FParticipantInfo {
	struct FString Name; // 0x00(0x10)
	struct FString Tag; // 0x10(0x10)
	struct FPremierRosterCustomization TeamCustomization; // 0x20(0x40)
};
...
struct FClientEndOfRoundPerformanceProfile {
	...
	struct FClientFrameBuckets FrameBuckets; // 0x618(0x24)
	char pad_63C[0x4]; // 0x63c(0x04)
	struct FString MatchID; // 0x640(0x10)
	int32_t RoundNumber; // 0x650(0x04)
	char pad_654[0x4]; // 0x654(0x04)
	int64_t RoundDuration; // 0x658(0x08)
	struct FString InstanceId; // 0x660(0x10)
	struct FPerfSettings Settings; // 0x670(0x50)
	struct FMachinePerfStats MachinePerfStats; // 0x6c0(0x64)
	char MoveTimestepsPerSecond; // 0x724(0x01)
	char pad_725[0x3]; // 0x725(0x03)
	struct FNetworkPacketStats NetworkPacketStats; // 0x728(0x54)
	char pad_77C[0x4]; // 0x77c(0x04)
	struct FNetworkLatencyStats NetworkLatencyStats; // 0x780(0x70)
	struct FString Puuid; // 0x7f0(0x10)
	struct FTelemetryPlatformInfo PlatformInfo; // 0x800(0x20)
};
...
struct FContractMatchResults {
	...
	struct TMap<struct FGuid, struct FRewardGrant> RewardGrants; // 0x98(0x50)
	struct TMap<struct FGuid, struct FMissionDelta> MissionDeltas; // 0xe8(0x50)
	struct TMap<struct FGuid, struct FContractDelta> ContractDeltas; // 0x138(0x50)
	bool CouldProgressMissions; // 0x188(0x01)
...
struct FDailyRewardsMatch {
	...
	struct TArray<bool> DailyBonusState; // 0x20(0x10)
};
...
struct FAresParty {
	...
	struct FTournamentData TournamentData; // 0x180(0x60)
	struct FString ClientVersion; // 0x1e0(0x10)
	int64_t Version; // 0x1f0(0x08)
	bool LookingForMore; // 0x1f8(0x01)
	char pad_1F9[0x7]; // 0x1f9(0x07)
	struct FCheatData CheatData; // 0x200(0x18)
	struct TArray<struct FString> EligibleQueues; // 0x218(0x10)
	struct TArray<struct FPartyXPBonus> XPBonuses; // 0x228(0x10)
	struct FString State; // 0x238(0x10)
	struct FString PreviousState; // 0x248(0x10)
	enum class EAresPartyAccessibility Accessibility; // 0x258(0x01)
	char pad_259[0x7]; // 0x259(0x07)
	struct FString StateTransitionReason; // 0x260(0x10)
	struct TArray<struct FPartyInvite> Invites; // 0x270(0x10)
	struct TArray<struct FPartyRequest> Requests; // 0x280(0x10)
	struct FDateTime QueueEntryTime; // 0x290(0x08)
	struct FAresPartyErrorNotification ErrorNotification; // 0x298(0x20)
	int64_t RestrictedSeconds; // 0x2b8(0x08)
	struct TArray<struct FQueueIneligibility> QueueIneligibilities; // 0x2c0(0x10)
};
...
struct FGradualCorrectionData {
	...
	struct FVector ClientToServerPositionDiff; // 0x0c(0x0c)
	struct FTimeStampIndex TimeStampIndex; // 0x18(0x04)
	bool bHasCorrection; // 0x1c(0x01)
	char pad_1D[0x3]; // 0x1d(0x03)
};
