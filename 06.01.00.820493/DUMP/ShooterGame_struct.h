...
enum class EAresFloatSettingName : uint8 {
	...
	GamepadBaseSpeedMultiplierXZoomed = 150,
	GamepadBaseSpeedMultiplierYZoomed = 151,
	GamepadMaxSpeedMultiplierXZoomed = 152,
	GamepadMaxSpeedMultiplierYZoomed = 153,
	GamepadMaxAccelerationThresholdZoomed = 154,
	GamepadAimAccelDelaySecondsZoomed = 155,
	GamepadAimAccelRampUpSecondsZoomed = 156,
	AimToolingAimAccelerationDelayDelayAmount = 157,
	AimToolingAimAccelerationDelayRampUpAmount = 158,
	ObserverRunSpeedModifier = 159,
	ObserverWalkSpeedModifier = 160,
	GyroShootingThresholdTap = 161,
	GyroShootingThresholdHold = 162,
	GyroShootingVisualBarMax = 163,
	GyroMovementWalkThresholdHorizontal = 164,
	GyroMovementWalkThresholdVertical = 165,
	GyroMovementRunThresholdHorizontal = 166,
	GyroMovementRunThresholdVertical = 167,
	GyroShotMovementDeadzoneThreshold = 168,
	GyroShotMovementDeadzoneValue = 169,
	EAresFloatSettingName_MAX = 170
};
...
struct FGetStorefrontResponseV3 {
	...
	struct FJuiceBoxStorefront JuiceBoxStore; // 0x158(0x18)
	struct FUpgradeCurrencyStorefront UpgradeCurrencyStore; // 0x170(0x10)
};
