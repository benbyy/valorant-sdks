...
enum class EAresBoolSettingName : uint8 {
	...
	GamepadEnableDampeningWhileAccelerated = 139,
	GamepadDampenLargeMovementsOnly = 140,
	GamepadInputDampeningEnabled = 141,
	MultithreadedRenderingEnabled = 142,
	HasEverStartedAMatch = 143,
	HasAcceptedCodeOfConduct = 144,
	HasSeenNewPlayerSettings = 145,
	HasSeenNPEContractTutorial = 146,
	HasSeenUPWTutorial = 147,
	HasSeenSettingsTutorial = 148,
	HasSeenWelcomeScreen = 149,
	HasSeenMenuTutorial = 150,
	HasSeenPhotoSensitivityWarning = 151,
	HasSeenTournamentsScreen = 152,
	HasSeenXGPActivationModal = 153,
	...
	HideCrosshair = 161,
	Hide1P = 162,
	ObserversSeeBlinds = 163,
	TeamColorAffectsHUD = 164,
	ShowKeybindsOnMinimap = 165,
	ShowKeybindsOnMegamap = 166,
	FullscreenMegamap = 167,
	HandednessByTeam = 168,
	HideSpectatedAgentPortrait = 169,
	ObserverToggleScoreboard = 170,
	TriggerSwapAll = 171,
	HasEverAppliedRoamingSettings = 172,
	GyroTapShoot = 173,
	GyroShootingAxisSwap = 174,
	GyroShootingAxisInvert = 175,
	GyroShootingDisplayBar = 176,
	GyroMovementAxisInvertVertical = 177,
	GyroMovementAxisInvertHorizontal = 178,
	EAresBoolSettingName_MAX = 179
};
