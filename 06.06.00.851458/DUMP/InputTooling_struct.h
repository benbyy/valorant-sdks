...
struct FAimToolingTargetManagementTuningSet {
	...
	float TargetManagementOverTargetWeight; // 0x14(0x04)
	bool bIsTargetManagementOverTargetNormalized; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	float TargetManagementDistanceWeight; // 0x1c(0x04)
	bool bIsTargetManagementDistanceNormalized; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
	float TargetManagementPreviousTargetWeight; // 0x24(0x04)
	float TargetManagementPreviousTargetDecay; // 0x28(0x04)
	bool ENGINEERING_ONLY_CHECK_TO_MODIFY_VALUES_BELOW; // 0x2c(0x01)
	char pad_2D[0x3]; // 0x2d(0x03)
	float PotentialTargetMaxAngle; // 0x30(0x04)
	float PotentialTargetQueryDist; // 0x34(0x04)
