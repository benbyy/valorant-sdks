...
enum class EAresFloatSettingName : uint8 {
	...
	GamepadSensitivityModifierX = 148,
	GamepadSensitivityModifierY = 149,
	GamepadSensModifierEaseInTime = 150,
	GamepadSensModifierEaseOutTime = 151,
	GamepadInputDampeningMinPercentX = 152,
	GamepadInputDampeningMinPercentY = 153,
	GamepadInputDampeningRampSecondsX = 154,
	GamepadInputDampeningRampSecondsY = 155,
	GamepadInputDampeningLargeMovementThresholdX = 156,
	GamepadInputDampeningLargeMovementThresholdY = 157,
	GamepadBaseSpeedMultiplierXZoomed = 158,
	GamepadBaseSpeedMultiplierYZoomed = 159,
	GamepadMaxSpeedMultiplierXZoomed = 160,
	GamepadMaxSpeedMultiplierYZoomed = 161,
	GamepadMaxAccelerationThresholdZoomed = 162,
	GamepadAimAccelDelaySecondsZoomed = 163,
	GamepadAimAccelRampUpSecondsZoomed = 164,
	AimToolingAimAccelerationDelayDelayAmount = 165,
	AimToolingAimAccelerationDelayRampUpAmount = 166,
	ObserverRunSpeedModifier = 167,
	ObserverWalkSpeedModifier = 168,
	GyroShootingThresholdTap = 169,
	GyroShootingThresholdHold = 170,
	GyroShootingVisualBarMax = 171,
	GyroMovementWalkThresholdHorizontal = 172,
	GyroMovementWalkThresholdVertical = 173,
	GyroMovementRunThresholdHorizontal = 174,
	GyroMovementRunThresholdVertical = 175,
	GyroShotMovementDeadzoneThreshold = 176,
	GyroShotMovementDeadzoneValue = 177,
	EAresFloatSettingName_MAX = 178
};
...
enum class EAresIntSettingName : uint8 {
	...
	PlayerPerf_LastSetting = 60,
	NetworkSmoothing = 61,
	ShootingRangeSkillTestSetting = 62,
	ShootingRangePlantModuleDifficultySetting = 63,
	ShootingRangeDefuseModuleDifficultySetting = 64,
	GamepadSavedPreset = 65,
	GamepadSavedAimCurve = 66,
	GamepadSavedAimCurveZoomed = 67,
	GamepadSavedAimCurveAngularDeadzone = 68,
	GamepadAnalogMoveThresholdMode = 69,
	TouchDoubleTapRight = 70,
	TouchHUDPreset = 71,
	TouchDoubleTapLeft = 72,
	TouchAimAccelerationCurveX = 73,
	TouchAimAccelerationCurveY = 74,
	TouchAimADSAccelerationCurveX = 75,
	TouchAimADSAccelerationCurveY = 76,
	TouchAimSniperAccelerationCurveX = 77,
	TouchAimSniperAccelerationCurveY = 78,
	TouchJoystickStyle = 79,
	TouchSniperZoomLevelSetting = 80,
	TouchOperatorZoomCycleStyle = 81,
	TouchOperatorZoomCycleStyle_CachedAllLevels = 82,
	TouchOperatorZoomCycleStyle_CachedLevelOne = 83,
	TouchOperatorZoomCycleStyle_CachedLevelTwo = 84,
	TouchAimSensitivityPreset = 85,
	TouchGyroSensitivityPreset = 86,
	TouchTrackballSensitivityPreset = 87,
	TouchDoubleTapTopLeft = 88,
	TouchDoubleTapTopMiddle = 89,
	TouchDoubleTapTopRight = 90,
	TouchDoubleTapMiddleLeft = 91,
	TouchDoubleTapMiddle = 92,
	TouchDoubleTapMiddleRight = 93,
	TouchDoubleTapBottomLeft = 94,
	TouchDoubleTapBottomMiddle = 95,
	TouchDoubleTapBottomRight = 96,
	TouchNumVerticalRegions = 97,
	TouchNumHorizontalRegions = 98,
	MaxFramerateInBuyPhase = 99,
	MaxFramerateInGamePhase = 100,
	MaxFramerateInSpectatorView = 101,
	LastSeenRoamingSettingsVersion = 102,
	EAresIntSettingName_MAX = 103
};
...
enum class EAresBoolSettingName : uint8 {
	...
	EnableHRTF = 55,
	ToggleTapHoldSwap = 56,
	EnableForceFeedback = 57,
	ShootingRangeBotArmorEnabled = 58,
	ShootingRangeBotStrafeEnabled = 59,
	ShootingRangeBotInfiniteAmmoEnabled = 60,
	...
	GamepadToggleCrouch = 134,
	GamepadToggleWalk = 135,
	GamepadDefaultToWalk = 136,
	GamepadHoldInputForADS = 137,
	GamepadHoldInputForScope = 138,
	GamepadToggleDropSpikeHold = 139,
	GamepadEnableDampeningWhileAccelerated = 140,
	GamepadDampenLargeMovementsOnly = 141,
	GamepadInputDampeningEnabled = 142,
	...
	CollectionShowOwnedOnly = 155,
	IncognitoHideMatchmadePlayerNames = 156,
	IncognitoRejectFriendRequests = 157,
	IncognitoRejectPartyInvitesByDisplayName = 158,
	PlayerBehavior_MuteEnemyTextChat = 159,
	PlayerBehavior_MuteObserverTextChat = 160,
	HideUI = 161,
	HideCrosshair = 162,
	Hide1P = 163,
	HideOutlinesAndFresnel = 164,
	ObserversSeeBlinds = 165,
	TeamColorAffectsHUD = 166,
	ShowKeybindsOnMinimap = 167,
	ShowKeybindsOnMegamap = 168,
	FullscreenMegamap = 169,
	HandednessByTeam = 170,
	HideSpectatedAgentPortrait = 171,
	ObserverToggleScoreboard = 172,
	TriggerSwapAll = 173,
...
enum class EGameFeatureToggleName : uint8 {
	...
	FXCPerspectiveUpdateFix = 109,
	EnableCypherGameObject = 110,
	FireButtonCustomization = 111,
	DevOnlyShop = 112,
	ServerValidateClientPredcitedUsables = 113,
	EnableJumpCrouch = 114,
	ChamberTPDeathBehaviorFix = 115,
	ReplicatedStateTransitionContext = 116,
	AllowGameplayTagFastReplication = 117,
	MoveDistributionTargeting = 118,
	EQSClearSpotForCharacterOverlapOffsetFix = 119,
	UseClientLocationForShots = 120,
	EnableGameplayFlagsTelemetry = 121,
	LineupCompass = 122,
	LineupOverlay = 123,
	RPCValidationWithDisconnect = 124,
	SendPerRoundNetworkTelemetryEvents = 125,
	DeathMatchPlayerSpawnedTelemetryEnabled = 126,
	AccurateWallMeshSeams = 127,
	LiveDiagnostics = 128,
	FXCInitialReplicationFix = 129,
	RemoteClientQueueSizeTrackingFix = 130,
	RoundEndMulticastBugfix = 131,
	ExpandedGestures = 132,
	SyncedTimerAuthStartUseCurrentTimestamp = 133,
	DeathPuckSizeAdjustment = 134,
	GyroShooting = 135,
	CustomCombatTrackerSupport = 136,
	UseAbilityTrackingComponent = 137,
	RestoreSetReplicatesRGIs = 138,
	FixActorComponentBlockingDormancy = 139,
	GyroMovement = 140,
	RelativeTriggerEnabled = 141,
	AudioVisualization = 142,
	AudioVisualizationIconFootstep = 143,
	AudioVisualizationLOS = 144,
	AudioVisualizationMaterialFootstep = 145,
	MultichannelAudioVisualization = 146,
	ReplicationSleepFix = 147,
	RevertMobileFiringError = 148,
	CancelUsableOnServerCorrect = 149,
	ProjectileBendingV2 = 150,
	BurstFire = 151,
	BuffDamageRefactor = 152,
	MinimapPauseUnseenEnemyUpdates = 153,
	SkyeSeekerRefactor = 154,
	SageWallFindFloorUsingCapsuleSweep = 155,
	ActorDormancyRespectsRelevancy = 156,
	BufferedZoomStates = 157,
	PODetection = 158,
	ExpireFoWCacheOnRoundBegin = 159,
	MobileAllySendRateLimiting = 160,
	MovementSyncDoor = 161,
	PremiumContentToggle0 = 162,
	PremiumContentToggle1 = 163,
	PremiumContentToggle2 = 164,
	PremiumContentToggle3 = 165,
	PremiumContentToggle4 = 166,
	PremiumContentToggle5 = 167,
	PremiumContentToggle6 = 168,
	PremiumContentToggle7 = 169,
	PremiumContentToggle8 = 170,
	PremiumContentToggle9 = 171,
	GradualMovementCorrections = 172,
	DebugMenuEnabledDefault = 173,
	UseMeshMaterialManager = 174,
	OmenCustomEQS = 175,
	OmenWallToggle = 176,
	VisionConeIntersectionFix = 177,
	FoWRelevancyCacheForceUpdate = 178,
	CorpsesBlockWorldDynamic = 179,
	PandemicToxicScreenCollisionFixes = 180,
	RateLimitClientInputs = 181,
	ErrorPowerByStabilityType = 182,
	AccoladesEnabled = 183,
	PremierGameEvents = 184,
	EquippableCacheRecycling = 185,
	ViperPitIgnoreCrawlspaceToggle = 186,
	PreventMovementInputEnforcement = 187,
	BufferedZoomRespectsValidStates = 188,
	EsportsGameEvents = 189,
	ScaledHeadshotFX = 190,
	ExplicitCharacterLoading = 191,
	MinimapFloors = 192,
	ShortTermNPEUpdates = 193,
	PatchHeightJumpCrouchExploitFix = 194,
	PatchHeightJumpCrouchExploitFixGekko = 195,
	FootstepDecayWhileWalking = 196,
	SystemicAbilityUpdates = 197,
	ConcussLowTickRate = 198,
	BombDestroysAllDestructibles = 199,
	OnlyDropCurrentEquippable = 200,
	FXCPerspectiveUpdatedOnSameFrameFix = 201,
	ObserverMinimapComponentLocation = 202,
	Count = 203,
	Invalid = 254,
...
enum class EGameRuleBoolName : uint8 {
	...
	AllowOvertimeDrawVote = 2,
	AllowLenientSurrender = 3,
	AllowDropOut = 4,
	SkipPregame = 5,
	AssignRandomAgents = 6,
	AllowGameModifiers = 7,
	TournamentMode = 8,
	MajorityVoteAgents = 9,
	PlayOutAllRounds = 10,
	SkipMatchHistory = 11,
	FillWithBots = 12,
	AllowDropIn = 13,
	UseMobileServerTickRate = 14,
	DestroyAbilitiesOnDeath = 15,
	PreventAbilityRecharge = 16,
	ReplayRecordMatch = 17,
	UseMapPicksAndBans = 18,
	AimToolingModule = 19,
	AimToolingBending = 20,
	AimToolingPullToCenter = 21,
	AimToolingAimAccelerationDelay = 22,
	AimToolingDeceleration = 23,
	AimToolingFrameOfReference = 24,
	AimToolingStrafeAssist = 25,
	AimToolingTargetFriction = 26,
	AimToolingFlashTurning = 27,
	MovementToolingModule = 28,
	MovementToolingShotRooting = 29,
	MovementToolingFastStrafing = 30,
	MovementToolingFastRelease = 31,
	PipAbilityCasting = 32,
	CombatReportOnlyShowLastLife = 33,
	UsePrototypePurchasables = 34,
	MobileDefaultFoV = 35,
	MobileGunStability = 36,
	ADSImprovements = 37,
...
enum class EGameFeatureFloatConfigName : uint8 {
	...
	AimToolingTuningMode = 23,
	MovementToolingTuningMode = 24,
	GamepadRecoilRecoveryMultiplier = 25,
	GamepadFlashTurningAimAccelDelayScale = 26,
	GamepadFlashTurningAimAccelRampUpScale = 27,
	...
	GameDataWorldSnapshotIntervalSec = 33,
	GameDataWorldConfigurationIntervalSec = 34,
	GameDataTimeseriesIntervalSec = 35,
	ShortTermNPEUpdatesChance = 36,
	Count = 37,
	Invalid = 254,
...
enum class EAresPlatformWidgetFamily : uint8 {
	...
	DailyRewards = 6,
	COUNT = 7,
	EAresPlatformWidgetFamily_MAX = 8
};
...
enum class ECapID : uint8 {
	...
	DoughID = 6,
	EquippableContentTypeID = 7,
	EquippableSkinContentTypeID = 8,
	EquippableSkinLevelContentTypeID = 9,
	EquippableSkinChromaContentTypeID = 10,
	EquippableCharmContentTypeID = 11,
	EquippableCharmLevelContentTypeID = 12,
	EquippableAttachmentContentTypeID = 13,
	CharacterContentTypeID = 14,
	SprayContentTypeID = 15,
	SprayLevelContentTypeID = 16,
	PlayerCardContentTypeID = 17,
	MissionContentTypeID = 18,
	PlayerTitleContentTypeID = 19,
	ContractContentTypeID = 20,
	PremiumContractContentTypeID = 21,
...
enum class EPlatformInitErrorReason : uint8 {
	...
	Count = 86,
	EPlatformInitErrorReason_MAX = 87
};
...
enum class EPlayerPerfMetricCategory : uint8 {
	...
	FiringError = 43,
	EnumCount = 44,
	EPlayerPerfMetricCategory_MAX = 45
};
...
enum class EAresPartyTournamentStartAvailability : uint8 {
	...
	Unavailable_LeagueMatchLimitReached = 6,
	Available_PartyLeader = 7,
	Available_NotPartyLeader = 8,
	TournamentStarted = 9,
	EAresPartyTournamentStartAvailability_MAX = 10
};
...
struct FTournamentData {
	...
	struct FString PremierSeasonID; // 0x30(0x10)
	struct TArray<struct FIneligibleRosterPartyMember> IneligibleRosterPartyMembers; // 0x40(0x10)
};
...
struct FMatchDetailsDTO {
	struct FMatchInfoDTO MatchInfo; // 0x00(0xd8)
	struct TArray<struct FPlayerDetailsDTO> Players; // 0xd8(0x10)
	struct TArray<struct FTeamDetailsDTO> Teams; // 0xe8(0x10)
	struct TArray<struct FRoundResultDTO> RoundResults; // 0xf8(0x10)
};
...
struct FMatchInfoDTO {
	...
	struct FPremierMatchInfoDTO PremierMatchInfo; // 0xa0(0x20)
	struct FGuid SeasonID; // 0xc0(0x10)
	bool IsCompleted; // 0xd0(0x01)
	bool IsRanked; // 0xd1(0x01)
...
struct FPremierLeaderboard {
	...
	char pad_34[0x4]; // 0x34(0x04)
	struct TArray<struct FPremierLeaderboardEntry> Entries; // 0x38(0x10)
};
...
struct FPremierLeaderboardEntry {
	...
	struct FString RosterName; // 0x08(0x10)
	struct FString Tag; // 0x18(0x10)
	struct FUnverifiedMetadataPersonalization Personalization; // 0x28(0x40)
	int32_t Wins; // 0x68(0x04)
	int32_t Losses; // 0x6c(0x04)
};
...
struct FAresSystemTelemetryMetrics {
	...
	struct FMetric Replication; // 0x3e8(0x14)
	struct FMetric Replication_Other; // 0x3fc(0x14)
	struct FMetric Idle; // 0x410(0x14)
	struct FMetric Other; // 0x424(0x14)
	struct FMetric Other_ActorTick; // 0x438(0x14)
	struct FMetric Other_ComponentTick; // 0x44c(0x14)
	struct FMetric Other_GameObjectTick; // 0x460(0x14)
	struct FMetric Other_GarbageCollection; // 0x474(0x14)
	struct FMetric Other_WorldTick; // 0x488(0x14)
	struct FMetric Other_TickPreRTG; // 0x49c(0x14)
	struct FMetric Other_TickPostRTG; // 0x4b0(0x14)
	struct FMetric Other_RunTickGroup; // 0x4c4(0x14)
	struct FMetric TempDebug; // 0x4d8(0x14)
	struct FMetric TempDebug_SubOne; // 0x4ec(0x14)
	struct FMetric TempDebug_SubTwo; // 0x500(0x14)
	struct FMetric TempDebug_SubThree; // 0x514(0x14)
	struct FMetric TempDebug_Other; // 0x528(0x14)
};
...
struct FContentListing {
	...
	struct TArray<struct FPremierConferenceCatalogData> PremierConferences; // 0x280(0x10)
	struct TArray<struct FStreamedVideoFileCatalogData> StreamedVideoFiles; // 0x290(0x10)
	struct FContractListing ContractListing; // 0x2a0(0x20)
	struct FServiceDictionary ServiceDictionary; // 0x2c0(0x50)
	struct TArray<struct FLevelBorderCatalogData> LevelBorders; // 0x310(0x10)
	struct TArray<struct FContentData> Ceremonies; // 0x320(0x10)
	struct TArray<struct FSubscriptionCatalogData> Subscriptions; // 0x330(0x10)
	struct TArray<struct FArchiveCatalogData> Archives; // 0x340(0x10)
};
...
struct FPremierSeasonCatalogData {
	...
	bool DevelopmentOnly; // 0x40(0x01)
	char pad_41[0x7]; // 0x41(0x07)
	struct TArray<struct FString> ExcludedPlatforms; // 0x48(0x10)
	struct TMap<struct FString, struct FPlatformInclusionFlags> IncludedPlatforms; // 0x58(0x50)
};
...
struct FClientPerRoundPerformanceData {
	...
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x34(0x53c)
	struct FClientFrameBuckets FrameBuckets; // 0x570(0x24)
	struct FMachinePerfStats MachinePerfStats; // 0x594(0x64)
	struct FAresObjectMetrics ObjectMetrics; // 0x5f8(0x64)
	char MoveTimestepsPerSecond; // 0x65c(0x01)
...
struct FClientEndOfRoundPerformanceProfile {
	...
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x28(0x53c)
	struct FAresObjectMetrics ObjectMetrics; // 0x564(0x64)
	struct FClientFrameBuckets FrameBuckets; // 0x5c8(0x24)
	char pad_5EC[0x4]; // 0x5ec(0x04)
	struct FString MatchID; // 0x5f0(0x10)
	int32_t RoundNumber; // 0x600(0x04)
	char pad_604[0x4]; // 0x604(0x04)
	int64_t RoundDuration; // 0x608(0x08)
	struct FString InstanceId; // 0x610(0x10)
	struct FPerfSettings Settings; // 0x620(0x50)
	struct FMachinePerfStats MachinePerfStats; // 0x670(0x64)
	char MoveTimestepsPerSecond; // 0x6d4(0x01)
	char pad_6D5[0x3]; // 0x6d5(0x03)
	struct FNetworkPacketStats NetworkPacketStats; // 0x6d8(0x54)
	char pad_72C[0x4]; // 0x72c(0x04)
	struct FNetworkLatencyStats NetworkLatencyStats; // 0x730(0x70)
	struct FString Puuid; // 0x7a0(0x10)
	struct FTelemetryPlatformInfo PlatformInfo; // 0x7b0(0x20)
};
...
struct FCNHopeNotification {
	...
	struct FString PolicyType; // 0x08(0x10)
	struct FString HopeMessage; // 0x18(0x10)
	int64_t LogoutTime; // 0x28(0x08)
	int64_t SecondsToLogoutTime; // 0x30(0x08)
};
...
struct FContractMatchResults {
	...
	struct FActPointGrants ActPointGrants; // 0x98(0x28)
	struct TMap<struct FGuid, struct FRewardGrant> RewardGrants; // 0xc0(0x50)
	struct TMap<struct FGuid, struct FMissionDelta> MissionDeltas; // 0x110(0x50)
	struct TMap<struct FGuid, struct FContractDelta> ContractDeltas; // 0x160(0x50)
	bool CouldProgressMissions; // 0x1b0(0x01)
...
struct FDailyRewardsMatch {
	...
	bool WasPenalized; // 0x20(0x01)
	bool WasBonusApplied; // 0x21(0x01)
...
struct FLeaderboardRankingDTO {
	...
	char pad_19[0x7]; // 0x19(0x07)
	struct FAdditionalData additionalInfo; // 0x20(0x68)
};
...
struct FClientReconnectToInGameLaunchTimes {
	struct FString InstanceId; // 0x00(0x10)
	struct FClientLaunchTimeStats ClientLaunchTimeStats; // 0x10(0x28)
};
...
struct FProcessedMatchDetails {
	struct FMatchInfoDTO MatchInfo; // 0x00(0xd8)
	struct UMapUIData* MapUIData; // 0xd8(0x08)
	struct UGameModeDataAsset* GameModeDataAsset; // 0xe0(0x08)
	struct USeasonDataAsset* SeasonDataAsset; // 0xe8(0x08)
	struct UCompetitiveSeasonDataAsset* CompetitiveSeasonDataAsset; // 0xf0(0x08)
	struct FDateTime GameStartTime; // 0xf8(0x08)
	struct FTimespan GameLength; // 0x100(0x08)
	struct TMap<struct FName, struct FTeamDetailsDTO> Teams; // 0x108(0x50)
	struct TMap<struct FString, struct FProcessedPlayerDetails> Players; // 0x158(0x50)
	struct TMap<int32_t, struct FProcessedRoundResult> RoundResults; // 0x1a8(0x50)
	struct TArray<struct FProcessedKillEvent> KillEvents; // 0x1f8(0x10)
...
// ScriptStruct ShooterGame.SetEventRequest
// Size: 0x10 (Inherited: 0x00)
struct FSetEventRequest {
...
struct FAresParty {
	...
	struct FTournamentData TournamentData; // 0x180(0x50)
	struct FString ClientVersion; // 0x1d0(0x10)
	int64_t Version; // 0x1e0(0x08)
	bool LookingForMore; // 0x1e8(0x01)
	char pad_1E9[0x7]; // 0x1e9(0x07)
	struct FCheatData CheatData; // 0x1f0(0x18)
	struct TArray<struct FString> EligibleQueues; // 0x208(0x10)
	struct TArray<struct FPartyXPBonus> XPBonuses; // 0x218(0x10)
	struct FString State; // 0x228(0x10)
	struct FString PreviousState; // 0x238(0x10)
	enum class EAresPartyAccessibility Accessibility; // 0x248(0x01)
	char pad_249[0x7]; // 0x249(0x07)
	struct FString StateTransitionReason; // 0x250(0x10)
	struct TArray<struct FPartyInvite> Invites; // 0x260(0x10)
	struct TArray<struct FPartyRequest> Requests; // 0x270(0x10)
	struct FDateTime QueueEntryTime; // 0x280(0x08)
	struct FAresPartyErrorNotification ErrorNotification; // 0x288(0x20)
	int64_t RestrictedSeconds; // 0x2a8(0x08)
	struct TArray<struct FQueueIneligibility> QueueIneligibilities; // 0x2b0(0x10)
};
...
struct FPremierRosterV2 {
	...
	struct FPremierRosterV2SeasonData season; // 0xb0(0x40)
	int32_t MinimumRequiredMembersForEnrollment; // 0xf0(0x04)
	int32_t MatchesSinceReset; // 0xf4(0x04)
	int32_t TournamentsSinceReset; // 0xf8(0x04)
	char pad_FC[0x4]; // 0xfc(0x04)
	struct FPremierRosterV2Version Version; // 0x100(0x10)
	int64_t UpdatedAt; // 0x110(0x08)
	int64_t CreatedAt; // 0x118(0x08)
};
...
struct FPremierRoster {
	...
	struct FString conference; // 0x18(0x10)
	int32_t Division; // 0x28(0x04)
	int32_t LeaguePointsBonusMatchesRemaining; // 0x2c(0x04)
	int32_t LeaguePointsBonusMatchesTotal; // 0x30(0x04)
	int32_t LeagueMatchesPlayed; // 0x34(0x04)
	int32_t TournamentsPlayed; // 0x38(0x04)
	bool IsEnrolled; // 0x3c(0x01)
	char pad_3D[0x3]; // 0x3d(0x03)
	int32_t MinimumRequiredMembersForEnrollment; // 0x40(0x04)
	char pad_44[0x4]; // 0x44(0x04)
	int64_t Version; // 0x48(0x08)
	int32_t Wins; // 0x50(0x04)
	int32_t GamesPlayed; // 0x54(0x04)
	struct FPremierRosterCustomization CustomizationData; // 0x58(0x40)
};
...
struct FPremierSeasonDTO {
	...
	struct FDateTime StartTime; // 0x30(0x08)
	struct FDateTime EndTime; // 0x38(0x08)
	struct FDateTime EnrollmentPhaseStartDateTime; // 0x40(0x08)
	struct FDateTime EnrollmentPhaseEndDateTime; // 0x48(0x08)
	int32_t ChampionshipPointRequirement; // 0x50(0x04)
	char pad_54[0x4]; // 0x54(0x04)
	struct FString ChampionshipEventID; // 0x58(0x10)
};
...
struct FServerRoundMetrics {
	...
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x98(0x53c)
	struct FServerFrameBuckets FrameBuckets; // 0x5d4(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x5f0(0x64)
};
...
struct FServerPerRoundPerformanceData {
	...
	struct FMetric ProcessingTime; // 0x20(0x14)
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x34(0x53c)
	struct FServerFrameBuckets FrameBuckets; // 0x570(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x58c(0x64)
	struct FAresObjectMetrics ObjectMetrics; // 0x5f0(0x64)
	int32_t ConcurrentServers; // 0x654(0x04)
	float MaxTickRate; // 0x658(0x04)
	char MoveTimestepsPerSecond; // 0x65c(0x01)
	char pad_65D[0x3]; // 0x65d(0x03)
};
...
struct FServerEndOfRoundPerformanceProfile {
	...
	int32_t RoundNumber; // 0x578(0x04)
	char pad_57C[0x4]; // 0x57c(0x04)
	int64_t RoundDuration; // 0x580(0x08)
	int32_t ConcurrentServers; // 0x588(0x04)
	struct FAresObjectMetrics ObjectMetrics; // 0x58c(0x64)
	struct FServerFrameBuckets FrameBuckets; // 0x5f0(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x60c(0x64)
	char MoveTimestepsPerSecond; // 0x670(0x01)
	char pad_671[0x3]; // 0x671(0x03)
	float MaxTickRate; // 0x674(0x04)
	struct FNetworkPacketStats NetworkPacketStats; // 0x678(0x54)
