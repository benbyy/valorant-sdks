...
struct UAresMinimapWidget_C : UAresMinimapWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function AresMinimapWidget.AresMinimapWidget_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x337bc90
	void Construct(); // Function AresMinimapWidget.AresMinimapWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x337bc90
	void ExecuteUbergraph_AresMinimapWidget(int32_t EntryPoint); // Function AresMinimapWidget.AresMinimapWidget_C.ExecuteUbergraph_AresMinimapWidget // (Final|UbergraphFunction) // @ game+0x337bc90
};
