...
struct UComp_PlayerCharacter_HealingTracker_C : UActorComponent {
	...
	void ReceiveBeginPlay(); // Function Comp_PlayerCharacter_HealingTracker.Comp_PlayerCharacter_HealingTracker_C.ReceiveBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x337bc90
	...
	void ExecuteUbergraph_Comp_PlayerCharacter_HealingTracker(int32_t EntryPoint); // Function Comp_PlayerCharacter_HealingTracker.Comp_PlayerCharacter_HealingTracker_C.ExecuteUbergraph_Comp_PlayerCharacter_HealingTracker // (Final|UbergraphFunction|HasDefaults) // @ game+0x337bc90
};
