...
struct ULibrary_GameMode_VO_C : UBlueprintFunctionLibrary {
	...
	void PlayAnnouncementForAll(struct UAkAudioEvent* Event, enum class VOPriorityEnum Priority, float QueueTimeout, struct UObject* __WorldContext); // Function Library_GameMode_VO.Library_GameMode_VO_C.PlayAnnouncementForAll // (Static|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x337bc90
