...
struct ADeathPing_C : ABasePing_C {
	...
	void Timeline_0_0__FinishedFunc(); // Function DeathPing.DeathPing_C.Timeline_0_0__FinishedFunc // (BlueprintEvent) // @ game+0x337bc90
	void Timeline_0_0__UpdateFunc(); // Function DeathPing.DeathPing_C.Timeline_0_0__UpdateFunc // (BlueprintEvent) // @ game+0x337bc90
	void ExecuteUbergraph_DeathPing(int32_t EntryPoint); // Function DeathPing.DeathPing_C.ExecuteUbergraph_DeathPing // (Final|UbergraphFunction) // @ game+0x337bc90
};
